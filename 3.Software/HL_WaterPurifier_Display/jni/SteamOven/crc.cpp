...
#ifdef CRC_COOUT
/* CRC ��λ�ֽ�ֵ�� */
code const unsigned char auchCRCHi[256] = {
...
code const unsigned char auchCRCLo[256] = {
...
unsigned short GetCRC16(unsigned char *puchMsg, unsigned char usDataLen){
	static idata unsigned char uchCRCHi; /* �� CRC �ֽڳ�ʼ�� */
	static idata unsigned char uchCRCLo; /* �� CRC �ֽڳ�ʼ�� */
	static idata unsigned uIndex; 		 /* CRC ѭ���е����� */
